...
class ObservationsArchiveData:
    ...
    @property
    def tempMax6hrC(self):
        return self.ob_data["tempMax6hrC"]

    @property
    def tempMax6hrF(self):
        return self.ob_data["tempMax6hrF"]

    @property
    def tempMin6hrC(self):
        return self.ob_data["tempMin6hrC"]

    @property
    def tempMin6hrF(self):
        return self.ob_data["tempMin6hrF"]
