...
class ObservationsSummaryPressure:
    """ Defines an object for the observations summary period pressure data. """

    pressure = {}

    def __init__(self, pressure_json):
        """
        Constructor - this takes an individual observations summary period's pressure json.
               {
                  "maxMB": 1024,
                  "maxIN": 30.24,
                  "minMB": 1020,
