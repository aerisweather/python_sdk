...
class ObservationsArchiveEndpoint(object):
    """ Defines the curtesy function for requesting observations archive data from the API. """

    def observations_archive(self,
        ...
        """ Performs an API request to get observations archive data for a specified location.
            ...
            Returns:
                - a list of ObservationsArchiveResponse objects if successful
