...
class ThreatsEndpoint(object):
    """ Defines the curtesy function for requesting threats data from the API. """
    ...
    def threats(self,
        ...
        """ Performs an API request to get threats data for a specified location.
            ...
            Returns:
                - a list of ThreatsResponse objects if successful
